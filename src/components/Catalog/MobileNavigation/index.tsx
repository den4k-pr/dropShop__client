    ...
    return (
        ...
        >
            ...
            <div className="mobNavigation__top">
                <h2 style={{textAlign: "left"}} className="main--title">Фільтри</h2>
                {boolRes && <button onClick={() => ClearFilter()} className="mobNavigation__top-clear">Очистити Фільтри</button>}
            </div>
            ...
            <form onSubmit={(e) => {
                ...
                <button  
                    style={{opacity: !boolRes ? "0.6" : "1", cursor: !boolRes ? "not-allowed" : "pointer"}} 
